...
public class NBeta extends DistBase  // Non-central Beta Distribution
{
    ...
    public static double cdf(double x, double a, double b, double ncp, boolean lower_tail, boolean log_p)
    {
        ...
        return cdf2(x, 1.0 - x, a, b, ncp, lower_tail, log_p);
    }
    ...
    private static double cdf2(double x, double o_x, double a, double b,
                               double ncp, boolean lower_tail, boolean log_p)
    {
        double ans = cdfRaw(x, o_x, a,b, ncp);
        if (lower_tail) {
    ...
    private static double cdfRaw(double x, double oXes, double a, double b, double ncp)
    {
